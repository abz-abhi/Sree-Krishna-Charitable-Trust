    ...
    <main className="bg-white text-gray-800">
      ...
      <section className="relative w-full h-[400px] sm:h-[500px] lg:h-[600px]">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-6">
          ...
          <p className="mt-4 text-lg sm:text-xl lg:text-2xl text-gray-100 max-w-2xl drop-shadow-md">
      ...
      <section className="py-16 sm:py-20 px-6 md:px-12 lg:px-20 bg-gradient-to-r from-[#fdf6f0] to-[#e8f0f2]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Image */}
          <div className="relative w-full h-[340px] sm:h-[420px] lg:h-[500px] rounded-lg overflow-hidden shadow-xl">
            <Image
      ...
      <section className="py-16 sm:py-20 px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="relative w-full h-[250px] sm:h-[300px] rounded-lg overflow-hidden shadow-lg">
            <Image
